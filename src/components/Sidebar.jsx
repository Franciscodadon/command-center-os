import { Home, Target, Grid2X2, FolderKanban, BarChart3, BookOpen, Calendar, Mail, Settings, LogOut, UserCircle, X } from 'lucide-react'
...
export default function Sidebar({ active, onChange, user, syncStatus, onSignOut, mobileOpen, onMobileClose }) {
  const syncDot = {
    synced:   'bg-green-500',
  ...
  return (
    <>
      ...
      <aside
        ...
        className={`sidebar-nav-list${mobileOpen ? ' sidebar-open' : ''} fixed left-0 top-0 h-screen flex flex-col z-20`}
      >
        {/* Logo & Wordmark */}
        ...
        <div className="px-5 py-4 border-b border-white/5">
          <div className="flex items-center gap-3">
            ...
            <button
              onClick={onMobileClose}
              style={{ background: 'none', border: 'none', cursor: 'pointer', color: 'rgba(247,244,239,0.4)', padding: 4, display: 'none' }}
